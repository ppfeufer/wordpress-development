...
class HtmlFormatter implements Formatter {
    ...
    public function __construct() {
        if(\WordPress\Utility\DebugUtility::config('validHtml')) {
            $this->def = [
                'base' => 'span',
                'tip' => 'div',
                'cell' => 'data-cell',
    ...
    public function startGroup($prefix = '') {
        $maxDepth = \WordPress\Utility\DebugUtility::config('maxDepth');
        ...
        $expLvl = \WordPress\Utility\DebugUtility::config('expLvl');
    ...
    public function endExp() {
        if(\WordPress\Utility\DebugUtility::config('showBacktrace') && ($trace = \WordPress\Utility\DebugUtility::getBacktrace())) {
    ...
    public function endRoot() {
        ...
        if(($timeout = \WordPress\Utility\DebugUtility::getTimeoutPoint()) > 0) {
    ...
    public static function getAssets() {
        ...
        if(\WordPress\Utility\DebugUtility::config('stylePath') !== false) {
            ?>
            <style>
            <?php \readfile(\str_replace('{:dir}', __DIR__, \WordPress\Utility\DebugUtility::config('stylePath'))); ?>
            </style>
            <?php
        }

        if(\WordPress\Utility\DebugUtility::config('scriptPath') !== false) {
            ?>
            <script>
            <?php \readfile(\str_replace('{:dir}', __DIR__, \WordPress\Utility\DebugUtility::config('scriptPath'))); ?>
            </script>
            <?php
        }
